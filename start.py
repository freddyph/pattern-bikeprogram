...
def resa(konto_balans,cykel_länk):
    """För resor"""
    ...
    while True:
        if batteri_status < 0.2 or konto_balans < 0:
        ...
        if riktning in vädersträck:
            ...
            if riktning == "norr":
                ...
                pris = funktioner.calculate_trip(priser, 1)
                funktioner.kontroll_tid_batteri_saldo(
                tid,
                batteri_status,
                balans_konto,
                id_resan,
